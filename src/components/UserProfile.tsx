...
import { ArrowLeft, User, Mail, MessageCircle, Calendar, Shield, Crown, Star, Settings, LogOut, Copy, CheckCircle, Package, Clock } from 'lucide-react';
            ...
            <div className={`${themeStyles.card} rounded-2xl p-6 border`}>
              ...
              {userPurchases.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <div className={`${themeStyles.card} p-4 rounded-xl border text-center bg-gradient-to-r from-green-500/10 to-emerald-500/10`}>
                    <CheckCircle className="w-8 h-8 text-green-400 mx-auto mb-2" />
                    <h4 className={`font-semibold ${themeStyles.text} mb-1`}>Active Services</h4>
